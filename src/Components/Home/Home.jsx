        ...
        <div className="container">
            ...
            <div className="card">
                <div className="card-body"> 
                    <h4 class="card-title text-center">Welcome to QA Cinemas</h4>
                    <h6 class="card-subtitle mb-2 text-muted text-center">Bringing the biggest blockbusters to you.</h6>
                    <hr></hr>
                    <br></br>
